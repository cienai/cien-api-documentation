const config = {
  ...
  // Make baseUrl configurable for smooth repo renames (defaults to new path)
  baseUrl: process.env.BASE_URL || '/cien-data-api-documentation/',
  ...
  projectName: process.env.PROJECT_NAME || 'cien-data-api-documentation',
